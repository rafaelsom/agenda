...
class Evento(models.Model):                                             #criando a CLASSE evento
    ...
    descricao = models.TextField(blank=True, null=True)                 #igual -> pode ser em branco e nulo
    data_evento = models.DateTimeField(verbose_name='Data do evento')   #DATETIMEFIELD -> campo de data e hora; não pode ser nulo
